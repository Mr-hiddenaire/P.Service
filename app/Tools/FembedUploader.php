...
class FembedUploader
{
    ...
    public function Run()
    {
        ...
        $free = $total - $used_now - 0.05 * 1024 * 1024 * 1024;
        ...
        Log::info('Fingerprint: '.$this->fingerprint.PHP_EOL);
        Log::info('Start to uploading');
        ...
        Log::info('Upload successfully'.PHP_EOL);
        ...
        if (!$res->success) {
            Log::info('But get video id failed'.PHP_EOL);
        ...
        Log::info('Great, Fembed ID: '.$res->data.PHP_EOL);
